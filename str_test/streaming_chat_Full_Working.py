                                ...
                                mutation.addedNodes.forEach(function(node) {{
                                    if (node.nodeType === Node.ELEMENT_NODE && !responseFound) {{
                                        ...
                                        if (isAssistantMessage(node)) {{
                                            ...
                                            // Improved completion check with better cleanup - DEBUG DISABLED
                                            ...
                                            completionCheckId = setInterval(() => {{
                                                ...
                                                // DEBUG DISABLED - no more console.log for completion debug
                    ...
                    if data.get("method") == "Runtime.consoleAPICalled":
                        ...
                        if args:
                            ...
                            if console_message == "RESPONSE_STARTED":
                                ...
                                break
                            # Only show ERROR messages, no more COMPLETION_DEBUG
