...
class SliderThumb:
    ...
    def SetPosition(self, pos):
        ...
        if self.parent.thumbs['low'] == self:  # This is the left thumb
            pos_x = min(pos_x, other_pos[0])  # Ensure it doesn't go past the right thumb
        else:  # This is the right thumb
            pos_x = max(pos_x, other_pos[0])  # Ensure it doesn't go past the left thumb
