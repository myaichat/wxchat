...
if len(sys.argv) < 2:
    print("❌ Usage: python grok_cdp_pychrome_hybrid_test.py \"Your question here\"")
    print("📝 Example: python grok_cdp_pychrome_hybrid_test.py \"What is the weather like today?\"")
    sys.exit(1)
...
print("🤖 GROK CDP + PYCHROME HYBRID TEST")
print("=" * 50)
