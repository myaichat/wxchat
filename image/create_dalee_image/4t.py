...
prompt = (
'''The image presents a surreal, symbolic scene set against the backdrop of Moscow's Red Square.
 In the foreground, a large cat's head with an intense, determined expression takes a defiant stance.
   The cat is wrapped into ukrainian flag . Shockingly, the iconic onion-domed buildings of St. 
   Basil's Cathedral and the Kremlin in the background are engulfed in flames and billowing smoke,
     depicting a devastating, war-torn scenario. The dark sky and wet, reflective plaza ground add to the dramatic, 
     ominous atmosphere. This striking digital artwork juxtaposes the resilient Ukrainian cat figure with the burning Russian 
     landmarks to create a bold visual statement about the Russia-Ukraine conflict. The unfazed cat in Ukrainian colors amidst 
     the destruction of renowned Russian sites conveys Ukrainian resolve and resistance in the face of Russian military 
     aggression and the ravages of war. Overall, the powerful imagery delivers an impactful denunciation of the turmoil, 
     devastation, and suffering caused by the
 Russian invasion of Ukraine through the surreal contrasts and symbolic elements,'''[:1000-1]
)
image_params = {
