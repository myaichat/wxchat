...
class SliderThumb:
    ...
    def SetPosition(self, pos):
        ...
        self.value = round_to_step(fraction_to_value(fraction, self.parent.GetMin(), self.parent.GetMax()), self.parent.step)
...
class TestFrame(wx.Frame):
    def __init__(self):
        ...
        self.rangeslider = RangeSlider(parent=panel, lowValue=0.0, highValue=1.1, minValue=0.0, maxValue=1.1,
                                       step=0.1, size=(300, 26))
