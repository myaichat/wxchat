...
from include.Prompt.Base.Base_InputPanel_Promptist_Microsoft import Base_InputPanel_Promptist_Microsoft
import torch
...
#old
class Copilot_InputPanel(wx.Panel, NewChat, GetClassName, Base_InputPanel_Promptist_Microsoft):
    subscribed=False
    def __init__(self, parent, tab_id):
        ...
        Base_InputPanel_Promptist_Microsoft.AddButtons_Level_1(self, askSizer)
        ...
        sizer = wx.BoxSizer(wx.VERTICAL)
        h_sizer = wx.BoxSizer(wx.HORIZONTAL)
        Base_InputPanel_Promptist_Microsoft.AddButtons_Level_2(self, h_sizer)
...
class Chat_InputPanel(wx.Panel, NewChat,GetClassName, Base_InputPanel_Promptist_Microsoft):
    def __init__(self, parent, tab_id):
        global chatHistory,  currentQuestion, currentModel
