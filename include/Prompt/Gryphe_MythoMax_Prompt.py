...
class ChatHist_ResponseStreamer:
    ...
    def stream_response(self, text_prompt, chatHistory, receiveing_tab_id, model):
        ...
        return ''.join(out)    
class Deepinfra_Chat_ResponseStreamer:
    subscribed=False
    def __init__(self):
        # Set your OpenAI API key here
        self.model={}
...
#old
class Copilot_InputPanel(wx.Panel, NewChat, GetClassName, Base_InputPanel_Gryphe_MythoMax):
    subscribed=False
    def __init__(self, parent, tab_id):
        ...
        Base_InputPanel_Gryphe_MythoMax.AddButtons_Level_1(self, askSizer)
        ...
        sizer = wx.BoxSizer(wx.VERTICAL)
        h_sizer = wx.BoxSizer(wx.HORIZONTAL)
        Base_InputPanel_Gryphe_MythoMax.AddButtons_Level_2(self, h_sizer)
...
class Chat_InputPanel(wx.Panel, NewChat,GetClassName, Base_InputPanel_Gryphe_MythoMax):
    def __init__(self, parent, tab_id):
        global chatHistory,  currentQuestion, currentModel
