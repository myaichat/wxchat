...
class Claude_AnthropicVision_Copilot_DisplayPanel(wx.Panel):
    def __init__(self, parent, tab_id, chat):
        super(Claude_AnthropicVision_Copilot_DisplayPanel, self).__init__(parent)
...
class Claude_AnthropicVision_Chat_DisplayPanel(StyledTextDisplay):
    def __init__(self, parent, tab_id, chat):
        StyledTextDisplay.__init__(self,parent)
        font = wx.Font(10, wx.FONTFAMILY_TELETYPE, wx.FONTSTYLE_NORMAL, wx.FONTWEIGHT_NORMAL)
...
class Claude_AnthropicVision_ChatDisplayNotebookPanel(wx.Panel):
    subscribed=False
    def __init__(self, parent, vendor_tab_id, ws_name):
        super(Claude_AnthropicVision_ChatDisplayNotebookPanel, self).__init__(parent)
        self.tabs={}
        ...
        if not Claude_AnthropicVision_ChatDisplayNotebookPanel.subscribed:
            ...
            Claude_AnthropicVision_ChatDisplayNotebookPanel.subscribed=True
...
#old
class Claude_AnthropicVision_Copilot_InputPanel(wx.Panel, NewChat, GetClassName, Base_InputPanel_Anthropic_Claude):
    subscribed=False
    def __init__(self, parent, tab_id):
        global chatHistory,  currentQuestion, currentModel
        super(Claude_AnthropicVision_Copilot_InputPanel, self).__init__(parent)
        NewChat.__init__(self)
        GetClassName.__init__(self)
        self.tabs={}
        self.image_id=1
        ...
        if not Claude_AnthropicVision_Copilot_InputPanel.subscribed:
                
            #pub.subscribe(self.SetException, 'fix_exception')
            pub.subscribe(self.SetChatDefaults  , 'set_chat_defaults')
            #pub.subscribe(self.SaveQuestionForTabId  ,  'save_question_for_tab_id')
            #pub.subscribe(self.RestoreQuestionForTabId  ,  'restore_question_for_tab_id')
            Claude_AnthropicVision_Copilot_InputPanel.subscribed=True
...
class Claude_AnthropicVision_Chat_InputPanel(wx.Panel, NewChat,GetClassName, Base_InputPanel_Anthropic_Claude):
    def __init__(self, parent, tab_id):
        global chatHistory,  currentQuestion, currentModel
        super(Claude_AnthropicVision_Chat_InputPanel, self).__init__(parent)
        NewChat.__init__(self)
        GetClassName.__init__(self)
        self.tabs={}
        self.tab_id=tab_id
