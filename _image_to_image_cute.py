...
prompt="""simplistic poster art of adorable cat with an expressive face, wearing a blue and yellow scarf.The background is blue and yellow.
Above the cat, the phrase "Slava Ukraini!" is written. To the right , there's a sunflower with yellow petals and a 
black center.The style is playful and childlike,charming,poster-like manner.2d"""
prompt="""
Simplistic poster art of an extremely adorable cat with an expressive face,wearing a blue and yellow scarf.The background is blue and yellow.Above the cat, the phrase "Slava Ukraini!".To the right,there's a sunflower with yellow petals 
and a black center.The style is playful, childlike,charming,poster-like manner.2D
"""
negative_prompt = (
...
negative_prompt = """
intricate, complex, realistic, detailed, muted, dull, serious, dark, lifelike, 3D, ornate, shading, photorealistic, plain, unappealing
"""
randomize_seed=True
