...
if 0:
    import include.Prompt.Gryphe_MythoMax_Prompt as Prompt_Infusion_Qwen_Qwen2

if 1:
    import include.Prompt.Gryphe_MythoMax_Prompt as Prompt_Fuser_Gryphe_MythoMax
