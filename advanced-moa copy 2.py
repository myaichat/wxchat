...
def run_llm(layer, model, prev_response=None):
...
def main():
    ...
    results = [run_llm(0, model) for model in reference_models]
    print("Running layers...")
    for i in range(1, layers - 1):
        print(f"Layer {i}")
        results = [run_llm(i, model, prev_response=results) for model in reference_models]
