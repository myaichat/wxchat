...
if 0:
    import include.Prompt.Promptist_Microsoft_Prompt as Prompt_Infusion_Qwen_Qwen2

if 0:
    import include.Prompt.Promptist_Microsoft_Prompt as Prompt_Fuser_Gryphe_MythoMax

if 0:
    import include.Prompt.Promptist_Microsoft_Prompt as Prompt_Fuser_Microsoft_Promptist

if 1:
    import include.Portrait.Fuser_SD_Portrait  as Portrait_Fuser_SD_VAE
...
class MyApp(wx.App):
    def OnInit(self):
        self.frame = MyFrame(f'Portrait Fuser')
        return True
