    ...
    def __init__(self):
        ...
        if 1:
            ...
            for row in range(rows):
                ...
                sbox.Add(h_sizers[row], 1, wx.EXPAND)
        ...
        if 1:
            ...
            self.number_of_images_choices = [str(i) for i in range(1, 7)]
            self.number_of_images = wx.ComboBox(self.panel, choices=self.number_of_images_choices)
            self.number_of_images.SetValue("2")  # Set default number of images
            self.num_of_im=2
            ...
            self.generate_button = wx.Button(self.panel, label=f'Generate {self.num_of_im} Images')
