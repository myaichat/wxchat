...
def query_openai_for_fix(description, file_name, code, error_message):
    ...
    Just show fix suggestion in a form of a simplified plan that another AI agent may follow to fix/test this bug in file provided, 
    do not show updated code, be to the point, fix only problem at hand, provide line number. Add 'implementation' steps into each plan option outligning how to actually implement it in current OS/software environment.
    Return output as json object listing all plan options numerated."""
