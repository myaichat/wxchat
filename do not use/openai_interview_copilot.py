...
if 0:
    import include.Voice.Interview_Copilot as Prompt_Infusion_Meta_Llama3

if 1:
    import include.Voice.Interview_Copilot as Interview_Copilot_OpenAI_Voice
...
class MyApp(wx.App):
    def OnInit(self):
        self.frame = MyFrame(f'OpenAI Interview Copilot')
        return True
